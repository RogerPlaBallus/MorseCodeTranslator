...
public class MorseCodeController {
    ...
    public String translateToMorse(String textToTranslate){
        ...
        for(Character letter : textToTranslate.toCharArray()){
            // translate the letter and then append to the returning value to be displayed on the GUI
    ...
    public void playSound(String[] morseMessage) throws InterruptedException, LineUnavailableException {
        // audio format specifies the audio properties like the type of sound we want
        ...
        for(String pattern : morseMessage){
            ...
            // waits a bit before playing the next sound
            Thread.sleep(dotDuration);
        }
    ...
    private void playBeep(SourceDataLine line, int duration){
        ...
        for(int i = 0; i < data.length; i++){
            ...
            // in the context of audio processing a byte is used to represent audio data because it
            // can represent both positive and negative amplitude of sound waves
